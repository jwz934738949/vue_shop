<template>
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="操作">
          <el-button icon="el-icon-edit" size="mini" type="primary" @click="showUpdateAddressDialog"></el-button>
          <el-button icon="el-icon-location" size="mini" type="success" @click="showProgressDialog"></el-button>
        </el-table-column>
      </el-table>
      <!--      分页功能-->
    ...
    <!--    修改地址对话框区-->
    <el-dialog title="修改地址" :visible.sync="updateDialogVisible" width="50%" @close="updateDialogClosed">
      <!--      内容-->
      <el-form :model="updateAddressForm" :rules="updateAddressFormRules" ref="updateAddressFormRef"
               label-width="100px">
        <el-form-item label="省市区/县" prop="address1">
          <el-cascader :options="cityData" v-model="updateAddressForm.address1"></el-cascader>
        </el-form-item>
